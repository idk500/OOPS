...
1. **AI助手提示** - 带有渐变背景的提示，建议直接将报告发送给AI助手以快速解决问题
2. **OOPS 推荐** - 默认的AI助手链接（DeepSeek Chat、Kimi AI、通义千问）
3. **[项目名称] 专属** - 项目特定的友情链接，从YAML配置中读取

每个友情链接都是可点击的卡片，带有悬停效果，方便快速访问相关资源。
