...
### 参考文件
- [`../deprecated/ref/sample.txt`](../deprecated/ref/sample.txt) - 客服问题总结（原始数据）
- [`../deprecated/ref/connectivity_test_report.json`](../deprecated/ref/connectivity_test_report.json) - 网络连通性测试报告
- [`../deprecated/ref/debug.bat`](../deprecated/ref/debug.bat) - 调试脚本参考

### 开发文档
- [`../deprecated/dev.md`](../deprecated/dev.md) - 原始开发计划（半成品）
